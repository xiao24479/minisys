...
function open_flash_chart_object_str( $width, $height, $url, $use_swfobject=true, $base='/ireport/_extends/ofc-library/' )
{
    //
...
function open_flash_chart_object( $width, $height, $url, $use_swfobject=true, $base='/ireport/_extends/ofc-library/' )
{
    //
